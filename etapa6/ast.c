...
void astPrint(AST *node, int level) {
    ...
    switch (node->type) {
        ...
        case AST_FLUX_CONTROLL_IF_ELSE:
        case AST_FLUX_CONTROLL_IF:       fprintf(stderr, "AST_FLUX_CONTROLL_IF|ELSE"); break;
...
char* astToCode(AST* node, int level) {
    ...
    switch (node->type) {
        ...
        case AST_ARRAY_ATTRIBUITION: {
            ...
            sprintf(attribuition, "%s[%s]=%s", node->symbol->text, arrayElement, value);
...
void printType(AST* node){
    switch (node->type) {
        ...
        case AST_FLUX_CONTROLL_IF_ELSE:       fprintf(stderr, "AST_FLUX_CONTROLL_IF_ELSE"); break;
        case AST_FLUX_CONTROLL_WHILE:    fprintf(stderr, "AST_FLUX_CONTROLL_WHILE"); break;
        case AST_FLUX_CONTROLL_GOTO:     fprintf(stderr, "AST_FLUX_CONTROLL_GOTO"); break;
